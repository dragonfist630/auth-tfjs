...
const Recognition = ({ userData, userId }) => {
  ...
  const recognize = async (net, letter) => {
    ...
    const tempCanvas = faceCanvasRef.current;
    tempCanvas.width = 200;
    tempCanvas.height = 200;
    const tempCtx = tempCanvas.getContext('2d');
    tempCtx.fillStyle = 'rgba(255, 255, 255)'; // Light white with 20% opacity
    ...
    // Draw the center 200x200 portion of the video onto the temporary canvas
    tempCtx.drawImage(
      video,
      centerX - 100,
      centerY - 100,
      200,
      200, // Source rectangle
      0,
      0,
      200,
    ...
    console.log(tempCtx);
    // Perform face detection on the temporary canvas
