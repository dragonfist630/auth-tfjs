...
const Recognition = ({ userData, userId }) => {
  ...
  // const [selectedHandSign, setSelectedHandSign] = useState('');
  const [countdown, setCountdown] = useState(60);
  const intervalRef = useRef(null);
  const navigate = useNavigate();
  const selectedHandSign = generateRandomLetter();
  console.log(selectedHandSign);
  ...
  useEffect(() => {
    ...
    // const handSign = generateRandomLetter();
    // setSelectedHandSign(handSign);
    // console.log(generateRandomLetter(), selectedHandSign);
    loadAndRunModels();
